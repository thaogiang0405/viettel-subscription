<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>DS đăng ký</span></a>
                <ul class="ml-menu">
                    <li><a href="{{route('ds_tra_truoc')}}">Trả trước</a></li>
                    <li><a href="{{route('ds_tra_sau')}}">Trả sau</a></li>
                </ul>
            </li>
