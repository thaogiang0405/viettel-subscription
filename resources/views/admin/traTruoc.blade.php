                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <button class="btn btn-viettel btn-sm btn-update-status" data-id="{{ $item->id }}">
                                                    Chưa xử lý
                                                </button>
                                            @endif
                                        </td>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll('.btn-update-status').forEach(button => {
        button.addEventListener('click', function() {
            ...
            fetch(`{{ url('/dang-ky-tra-truoc/update-sim-status') }}/${id}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                },
                // body: JSON.stringify({ sim: simValue, : 'Hoàn thành' })
                body: JSON.stringify({ sim: simValue, status: 'Hoàn thành' })
            })
